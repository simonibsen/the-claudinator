...
6. **Update progress.md** with the quiz result.

## Question quality bar

- No yes/no questions (no signal).
- No questions that can be Googled in five seconds.
- The application questions should be drawn from realistic situations, not contrived.
- At least one question should require them to admit "I don't know" if they don't — that's a valid answer and useful.

## When they're clearly winging it

Call it out. "That sounds like a guess — do you actually know, or are you reasoning from first principles?" Both can be valid, but they should know which they're doing.

## Tone

Serious, fair, a little tough. Not mean. They are there to learn what they don't know — make that safe.
